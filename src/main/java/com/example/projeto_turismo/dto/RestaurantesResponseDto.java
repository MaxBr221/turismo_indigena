...
public class RestaurantesResponseDto {
    ...
    public RestaurantesResponseDto(String nome, String descricao, String tipo, String localizacao, String horarioFuncionamento, String telefone, String redeSociais) {
        this.nome = nome;
